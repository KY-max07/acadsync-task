...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-black flex flex-col font-body">
      {/* Navigation */}
      <nav className="flex justify-between items-center p-4 md:p-4 border-b border-black sticky top-0 bg-white z-50">
      <div className="flex items-center justify-center gap-3 md:gap-5">
        ...
        <div className="hidden md:flex space-x-8 items-center">
          <Link to="/login" className="text-lg hover:italic transition-all underline">Login</Link>
